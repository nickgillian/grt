...
const char *help = "This tool can be used for training a Softmax classification model.\n"
...
bool train( CommandLineParser &parser ){
    ...
    string kernelStr = "";
    string svmTypeStr = "";
    SVM::SVMKernelTypes kernel = SVM::LINEAR_KERNEL;
    SVM::SVMTypes svmType = SVM::C_SVC;
    ...
    bool useCV = false;
    UINT kFoldValue = 10;
    SVM classifier(kernel,svmType,scaleData,enableNullRejection,estimateGamma,gamma,degree,coef0,nu,C,useCV,kFoldValue);
